...
- Added main-screen transcript text selection: drag to select a range with live highlight, double-click for words, triple-click for lines; the selection copies via OSC 52 and starting a drag holds the viewport so streaming cannot yank it mid-select.
